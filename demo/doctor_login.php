      ...
      <div class="container">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-12">
			...
			<center><h1>DOCTOR LOGIN HERE </h1></center><br/>
              ...
              <div class="text-center">
				  <button type="submit"><a href="doctor_reg.php" style="color:white">Sign Up? </a></button>
...
if (isset($_POST['login'])) {
  ...
  $query=mysqli_query($conn,"SELECT * FROM doctor WHERE name = '$name' AND pwd = '$password' ");
