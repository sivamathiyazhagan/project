...
<head>
  ...
  <title>Health care Provider Login</title>
      ...
      <div class="container">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-12">
			...
			<center><h1>HEALTHCARE PROVIDER LOGIN HERE </h1></center><br/>
          ...
          <br>If You haven't already Accout?<a href="healthcare_provider_reg.php" > Click Here </a>
			  </div>
            </form>
          </div>
...
if (isset($_POST['login'])) {
  ...
  $query=mysqli_query($conn,"SELECT * FROM health_car_provider WHERE name = '$name' AND pwd = '$password' 
  AND status=1");
$n=mysqli_num_rows($query);
            ...
            if($n>0)
            {
              ...
              header("location:healthcare_home.php");
            }
            else{
              echo "<script>
                  alert('invalid login');
