      ...
      <div class="container">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-12">
			...
			<center><h1>DOCTOR REGISTRATION HERE </h1></center><br/>
              <div class="form-row">
                ...
                <div class="col-md-6 form-group">
                  <input type="doctor_id" class="form-control" name="doctor_id" id="doctor_id" placeholder="Your id" data-rule="doctor_id" data-msg="Please enter a valid id" />
                  <div class="validate"></div>
                </div>
              </div>
			  ...
			  <div class="form-row">
			   ...
			   <div class="form-row">
                ...
                <div class="col-md-6 form-group">
				  ...
				  <option value="herat diseases">HEART DISEASES</option>
				  <option value="cardiologist">CARDIOLOGIST</option>
				  <option value="ent specialist">ENT SPECIALIST</option>
				  <option value="pshychitrists">PSHYCHITRISTS</option>
              ...
              <div class="form-row">
                <div class="col-md-12 form-group">
                  <select class="form-control" name="qulification" id="qulification">
...
include 'db.php';
  if (isset($_POST['register'])) {
    extract($_POST);
    $sql="INSERT INTO `doctor`(`name`, `id`, `pwd`, `dob`, `gender`,`specialist`, `qulification`,`country`) VALUES ('$name','$id','$password','$dob','$gender','$specialist','$qulification','$country')";
    if ($conn->query($sql) === TRUE) {
      echo "<script>alert('New doctor Registered successfully');
