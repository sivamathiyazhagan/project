      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
         ...
         <!-- <li class="drop-down"><a href="">Drop Down</a>
          ...
          <li><a href="ehr_register.php">Register</a></li>
      ...
      <div class="container">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-12">
			...
			<center><h1>EHR REGISTRATION HERE </h1></center><br/>
              <div class="form-row">
...
include 'db.php';
  if (isset($_POST['register'])) {
    extract($_POST);
    $status=0;
    $sql="INSERT INTO `health_car_provider`(`name`, `email`, `pwd`, `dob`, `role`, `state`, `country`, `status`) VALUES ('$name','$email','$password','$dob','$gender','$state','$country','$status')";
    if ($conn->query($sql) === TRUE) {
      echo "<script>alert('New Ehr Registered successfully');
	  window.location.href='ehr_login.php';
	  </script>";
    }   
    else {
