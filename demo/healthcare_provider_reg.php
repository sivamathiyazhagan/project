...
<head>
  ...
  <title>Health care Provider Register</title>
      ...
      <div class="container">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-12">
			...
			<center><h1>HEALTH CARE PROVIDER REGISTRATION HERE </h1></center><br/>
              <div class="form-row">
...
include 'db.php';
  if (isset($_POST['register'])) {
    $status=0;
    extract($_POST);
    $sql="INSERT INTO `health_car_provider`(`name`, `email`, `pwd`, `dob`, `role`, `state`, `country`, `status`, `gender`) VALUES ('$name','$email','$password','$dob','$role','$state','$country','$status','$gender')";
    if ($conn->query($sql) === TRUE) {
      echo "<script>alert('New Health care provider Registered successfully');
	   window.location.href='healthcare_provider_login.php';
	  </script>";
    }   
    else {
