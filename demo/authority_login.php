    ...
    <section id="contact" class="contact section-bg">
      <div class="container">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-12">
            <form action="authority_home.php" method="post" role="form" class="php-email-form">
			<center><h1>AUTHORITY LOGIN HERE </h1></center><br/>
...
<?php
  ...
  $query=mysqli_query($conn,"SELECT * FROM authority WHERE name = '$name' AND pwd = '$password'");
